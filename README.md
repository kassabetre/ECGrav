...
> **Status:** 1.9.1. Actively developed research code. See [ROADMAP.md](ROADMAP.md)
...
```wolfram
PacletInstall["/path/to/ECGrav/build/ECGrav-1.9.1.paclet", ForceVersionInstall -> True];
Needs["ECGrav`"];
```
...
current release (1.9.1). Earlier releases are preserved as git tags:

- `v1.9.1` — current: the empty complex had no Euler characteristic — `EulerChi[{}]`
